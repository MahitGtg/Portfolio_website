      ...
      <div className="relative w-full h-full rounded-lg border border-slate-200/20 bg-black/80 backdrop-blur-sm overflow-hidden flex flex-col justify-center p-3 shadow-lg">
        ...
        <div className="space-y-2 flex-1 flex flex-col justify-center">
          <div className="bg-white/5 rounded-lg border border-slate-200/20 px-2.5 py-1.5">
            <div className="text-[9px] text-white/50 uppercase tracking-wider mb-0.5">Premise</div>
            <div className="text-white/90 text-xs">{NLI_PREMISE}</div>
          </div>
          <div className="bg-white/5 rounded-lg border border-slate-200/20 px-2.5 py-1.5">
            <div className="text-[9px] text-white/50 uppercase tracking-wider mb-0.5">Hypothesis</div>
        ...
        <div className="mt-2 pt-2 border-t border-slate-200/20 space-y-1.5">
          {phase === 'model' && (
            <div className="flex items-center justify-between">
              <span className="text-[9px] text-white/50 uppercase tracking-wider">Model</span>
              <span className="text-xs font-medium text-white/90">{activeModel}</span>
            </div>
          )}
          {phase === 'attention' && (
            <div className="space-y-1">
              <span className="text-[9px] text-white/50 uppercase tracking-wider">Attention</span>
          ...
          {phase === 'result' && (
            <div className="flex items-center justify-between gap-2">
              <span className="text-[9px] text-white/50 uppercase tracking-wider">Output</span>
              <div
                key={resultKey}
