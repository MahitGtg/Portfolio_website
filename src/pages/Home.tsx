import { Code, Library, Mail, MapPin, Wrench } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
      {Object.entries(categories).map(
        ([category, { icon: CategoryIcon, techs }]) => (
          <div
            key={category}
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-xl font-secondary font-medium text-[#aab8d4]">
                {category}
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-1.5">
              {techs.map(({ Icon, name }) => (
                ...
                >
                  ...
                  <span
                    className="text-m font-secondary font-semi text-[#aab8d4]
...
const LoadingSpinner = () => (
  <div className="h-32 w-32 relative">
    ...
    />
    <div
      className="absolute inset-2 border-8 border-navy-600/40 rounded-full 
                    animate-[spin_2s_linear_infinite_reverse]"
    />
    <div
      className="absolute inset-4 border-8 border-slate-300/50 rounded-full 
          ...
          >
            ...
            >
              ...
              <div className="space-y-1 mb-4">
                ...
                <h1
                  className="font-main text-5xl md:text-7xl font-black text-white/80
                                             tracking-tight"
                >
                  Mahit Gupta
                </h1>
